  ...
  return (
    <div>{/* SEO tags */}
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="mb-6 animate-fade-up">Discover Novyra <span className="text-primary">Life Sciences</span></h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative animate-slide-in-left">
              <div className="aspect-w-4 aspect-h-3 rounded-lg overflow-hidden shadow-medium hover-lift">
                <img
                  src={teamMeetingImage}
                  alt="Professional engineering team meeting discussing technical projects"
                  className="w-full h-96 object-cover rounded-lg transition-transform duration-700 hover:scale-105"
                />
              </div>
              <div className="absolute -bottom-8 -right-8 bg-primary p-6 rounded-lg text-primary-foreground shadow-golden animate-bounce-in animate-stagger-3 hover-pulse">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={service.title} className={`card-professional p-8 text-center hover-lift animate-fade-up animate-stagger-${index + 1}`}>
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce-in animate-stagger-3 hover-pulse">
                  <service.icon className="w-8 h-8 text-primary transition-transform duration-300 hover:scale-110" />
                </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="bg-card p-8 rounded-lg shadow-medium animate-slide-in-left hover-lift">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li className="animate-fade-up animate-stagger-4 transition-colors duration-300 hover:text-primary">• Uncompromising technical excellence and precision</li>
                <li className="animate-fade-up animate-stagger-5 transition-colors duration-300 hover:text-primary">• Ethical leadership in all professional engagements</li>
                <li className="animate-fade-up animate-stagger-6 transition-colors duration-300 hover:text-primary">• Innovation through strategic collaborative partnerships</li>
                <li className="animate-fade-up animate-stagger-6 transition-colors duration-300 hover:text-primary">• Dedication to environmental sustainability and responsibility</li>
              </ul>
            </div>
            <div className="relative animate-slide-in-right">
              <img
                ...
                className="w-full h-96 object-cover rounded-lg shadow-medium transition-transform duration-700 hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent rounded-lg transition-opacity duration-300 hover:opacity-50"></div>
              <div className="absolute bottom-6 left-6 text-white animate-fade-up animate-stagger-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {expertise.map((area, index) => (
              <div key={area} className={`bg-card p-6 rounded-lg border border-border/50 hover-glow transition-all duration-300 animate-fade-up animate-stagger-${(index % 6) + 1}`}>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-primary rounded-full animate-pulse-slow"></div>
                  <h4 className="font-semibold transition-colors duration-300 hover:text-primary">{area}</h4>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover-lift animate-fade-up animate-stagger-1">
              <h3 className="mb-3 text-lg font-semibold transition-colors duration-300 hover:text-primary">What types of engineering roles do you specialize in?</h3>
            ...
            <div className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover-lift animate-fade-up animate-stagger-2">
              <h3 className="mb-3 text-lg font-semibold transition-colors duration-300 hover:text-primary">How long does the typical recruitment process take?</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover-lift animate-fade-up animate-stagger-3">
              <h3 className="mb-3 text-lg font-semibold transition-colors duration-300 hover:text-primary">Do you offer temporary or contract staffing solutions?</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover-lift animate-fade-up animate-stagger-4">
              <h3 className="mb-3 text-lg font-semibold transition-colors duration-300 hover:text-primary">What sets Novyra <span className="text-primary">Life Sciences</span> apart from other staffing agencies?</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover-lift animate-fade-up animate-stagger-5">
              <h3 className="mb-3 text-lg font-semibold transition-colors duration-300 hover:text-primary">Do you provide consulting services beyond staffing?</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover-lift animate-fade-up animate-stagger-6">
              <h3 className="mb-3 text-lg font-semibold transition-colors duration-300 hover:text-primary">What geographic regions do you serve?</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover-lift animate-fade-up animate-stagger-6">
              <h3 className="mb-3 text-lg font-semibold transition-colors duration-300 hover:text-primary">How do you ensure candidate quality and technical competency?</h3>
              <p className="text-muted-foreground leading-relaxed">
